# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-01-31 11:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.CharField(help_text='Иконка FontAwesome. Пример: fa-user.', max_length=50, null=True)),
                ('access_permissions', models.ManyToManyField(blank=True, to='auth.Permission', verbose_name='Permissions granting access')),
                ('parent', models.ForeignKey(blank=True, help_text='Parent site tree item.', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sitetreeitem_parent', to='hh.SiteTreeItem', verbose_name='Parent')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='tree',
            field=models.ForeignKey(help_text='Site tree this item belongs to.', on_delete=django.db.models.deletion.CASCADE, related_name='sitetreeitem_tree', to='hh.SiteTreeTree', verbose_name='Site Tree'),
        ),
